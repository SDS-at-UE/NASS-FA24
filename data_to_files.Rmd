...
write.csv(animal_products, "DATA_FILES/animal_products.csv")
write.csv(crops, "DATA_FILES/crops.csv")
write.csv(demographics, "DATA_FILES/demographics.csv")
write.csv(economics, "DATA_FILES/economics.csv")
write.csv(environmental, "DATA_FILES/environmental.csv")
