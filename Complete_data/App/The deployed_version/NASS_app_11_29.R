...
#######################  Loading the data  #############################
url_1 <- "https://github.com/SDS-at-UE/NASS-FA24/blob/main/Complete_data/App/new_data2/corn_census_final.rda?raw=true"
url_var = url(url_1)
load(url_var)
close(url_var)

url_2 <- "https://github.com/SDS-at-UE/NASS-FA24/blob/main/Complete_data/App/new_data2/corn_county_geometry.rda?raw=true"
url_var = url(url_2)
  load(url_var)
close(url_var)

url_3 <- "https://github.com/SDS-at-UE/NASS-FA24/blob/main/Complete_data/App/new_data2/corn_state_geometry.rda?raw=true"
url_var = url(url_3)
  load(url_var)
close(url_var)

url_4 <- "https://github.com/SDS-at-UE/NASS-FA24/blob/main/Complete_data/App/new_data2/corn_survey_final.rda?raw=true"
url_var = url(url_4)
  load(url_var)
close(url_var)

url_5 <- "https://github.com/SDS-at-UE/NASS-FA24/blob/main/Complete_data/App/new_data2/corn_survey_week_final.rda?raw=true"
url_var = url(url_5)
  load(url_var)
close(url_var)

url_6 <- "https://github.com/SDS-at-UE/NASS-FA24/blob/main/Complete_data/App/new_data2/potatoes_census_final.rda?raw=true"
url_var = url(url_6)
  load(url_var)
close(url_var)

url_7 <- "https://github.com/SDS-at-UE/NASS-FA24/blob/main/Complete_data/App/new_data2/potatoes_county_geometry.rda?raw=true"
url_var = url(url_7)
  load(url_var)
close(url_var)

url_8 <- "https://github.com/SDS-at-UE/NASS-FA24/blob/main/Complete_data/App/new_data2/potatoes_state_geometry.rda?raw=true"
url_var = url(url_8)
  load(url_var)
close(url_var)

url_9 <- "https://github.com/SDS-at-UE/NASS-FA24/blob/main/Complete_data/App/new_data2/potatoes_survey_final.rda?raw=true"
url_var = url(url_9)
  load(url_var)
close(url_var)

url_10 <- "https://github.com/SDS-at-UE/NASS-FA24/blob/main/Complete_data/App/new_data2/potatoes_survey_week_final.rda?raw=true"
url_var = url(url_10)
  load(url_var)
close(url_var)

url_11 <- "https://github.com/SDS-at-UE/NASS-FA24/blob/main/Complete_data/App/new_data2/soybeans_census_final.rda?raw=true"
url_var = url(url_11)
  load(url_var)
close(url_var)

url_12 <- "https://github.com/SDS-at-UE/NASS-FA24/blob/main/Complete_data/App/new_data2/soybeans_county_geometry.rda?raw=true"
url_var = url(url_12)
  load(url_var)
close(url_var)

url_13 <- "https://github.com/SDS-at-UE/NASS-FA24/blob/main/Complete_data/App/new_data2/soybeans_state_geometry.rda?raw=true"
url_var = url(url_13)
  load(url_var)
close(url_var)

url_14 <- "https://github.com/SDS-at-UE/NASS-FA24/blob/main/Complete_data/App/new_data2/soybeans_survey_final.rda?raw=true"
url_var = url(url_14)
  load(url_var)
close(url_var)

url_15 <- "https://github.com/SDS-at-UE/NASS-FA24/blob/main/Complete_data/App/new_data2/soybeans_survey_week_final.rda?raw=true"
url_var = url(url_15)
  load(url_var)
close(url_var)

url_16 <- "https://github.com/SDS-at-UE/NASS-FA24/blob/main/Complete_data/App/new_data2/wheat_census_final.rda?raw=true"
url_var = url(url_16)
  load(url_var)
close(url_var)

url_17 <- "https://github.com/SDS-at-UE/NASS-FA24/blob/main/Complete_data/App/new_data2/wheat_county_geometry.rda?raw=true"
url_var = url(url_17)
  load(url_var)
close(url_var)

url_18 <- "https://github.com/SDS-at-UE/NASS-FA24/blob/main/Complete_data/App/new_data2/wheat_state_geometry.rda?raw=true"
url_var = url(url_18)
  load(url_var)
close(url_var)

url_19 <- "https://github.com/SDS-at-UE/NASS-FA24/blob/main/Complete_data/App/new_data2/wheat_survey_final.rda?raw=true"
url_var = url(url_19)
  load(url_var)
close(url_var)

url_20 <- "https://github.com/SDS-at-UE/NASS-FA24/blob/main/Complete_data/App/new_data2/wheat_survey_week_final.rda?raw=true"
url_var = url(url_20)
  load(url_var)
close(url_var)


url_21 <- "https://github.com/SDS-at-UE/NASS-FA24/blob/main/Complete_data/App/new_data2/corn_county_distances.rda?raw=true"
url_var = url(url_21)
load(url_var)
close(url_var)

url_22 <- "https://github.com/SDS-at-UE/NASS-FA24/blob/main/Complete_data/App/new_data2/potatoes_county_distances.rda?raw=true"
url_var = url(url_22)
load(url_var)
close(url_var)

url_23 <- "https://github.com/SDS-at-UE/NASS-FA24/blob/main/Complete_data/App/new_data2/soybeans_county_distances.rda?raw=true"
url_var = url(url_23)
load(url_var)
close(url_var)

url_24 <- "https://github.com/SDS-at-UE/NASS-FA24/blob/main/Complete_data/App/new_data2/wheat_county_distances.rda?raw=true"
url_var = url(url_24)
load(url_var)
close(url_var)
                      ...
                      fluidRow(
                        tags$head(tags$style(HTML("
                          ...
                          table {
                            ...
                            border-collapse: collapse; /* Optional: Cleaner table appearance */
                          }
                        "))),
                        column(3,
                            ...
                            fluidRow(
                                     ...
                                     column(3,
                                            selectInput(inputId = "level2", "Choose a level", 
                                                        c("State"),
                                                        selected = "State"),
                                            tags$script("$('#level2').attr('disabled', true);"),
...
server <- function(input, output,session) {
  ...
  #   # Check if input$unit is valid and toggle_map is TRUE
  #   req(input$unit, input$toggle_map == TRUE)
  #   
  ...
  #   
  #   # Ensure that valid columns are found
  #   if (length(ttt) == 0) {
  #     return(data.frame(Message = "No columns with '_' found in the data"))
  #   }
  #   
  #   # Transpose the selected data
  #   tt <- t(Data[, ttt, drop = FALSE])
  #   
  ...
  #     tt == "(D)", 
  #     "(D)", 
  #     prettyNum(as.numeric(tt), big.mark = ",", scientific = FALSE)
  #   )
  #   
  ...
  output$msg_pop <- renderTable({
    ...
    if(length(strsplit(as.character(req(input$unit)), "")) != 0 & input$toggle_map == TRUE){
      ...
      # Format values: Keep "(D)" as is, and apply formatting to numeric values
      tt <- ifelse(tt == "(D)", "(D)", format(round(as.numeric(tt), digits = 0), big.mark = ",", scientific = FALSE))
  ...
  output$msg_pop_total <- renderTable({
    ...
    if (input$update_map) {
      ...
      # Format values: Keep "(D)" as is, and apply formatting to numeric values
      tt$Values <- ifelse(tt$Values == "(D)", "(D)", format(round(as.numeric(tt$Values), digits = 0), big.mark = ",", scientific = FALSE))
  ...
  output$progress <- renderPlot({
    if(input$toggle_map == TRUE& input$level == "State"){
      ...
      if(input$crop == "Wheat"){
        ...
        df3 <- df3%>%
          mutate(across(starts_with("PROGRESS"), ~ . / max(., na.rm = T) * 100)) %>%
      ...
      if(input$crop == "Corn"){
        ...
        ggplot(data = df3_long, aes(x = Week_Num, y = Value, color = Category, linetype = Type)) +
          ...
          labs(
            title = "Progress of winter wheat by Category Over Weeks",
            x = "Week Number (Wheat Adjusted to Begin Week 35)",
            y = "Percentage",
            color = "Category",
            linetype = "Legend"
  ...
  output$state1 <- renderUI({
    if(length(strsplit(as.character(req(input$crop2)), "")) != 0 &
      ...
      selectInput("state1", 
                  ...
                  multiple = F,
                  selected = unique(data_new2()$STATE_NAME)[1])
    } 
  })
  ...
  output$state2 <- renderUI({
    if(length(strsplit(as.character(req(input$crop2)), "")) != 0 &
      ...
      selectInput("state2", 
                  ...
                  choices = unique(data_new2()$STATE_NAME),# unique_products,
                  multiple = F,
                  selected = unique(data_new2()$STATE_NAME)[2])
    } 
  })
  ...
  output$corn_intro <- renderTable({
    df <- corn_survey_final %>% 
      ...
      group_by(YEAR) %>% 
      summarise(
        Average_YIELD = round(sum(`PRODUCTION_BU`, na.rm = TRUE)/sum(`AREA HARVESTED_ACRES`, na.rm = TRUE), digits = 0),
        Total_Production = round(sum(`PRODUCTION_BU`, na.rm = TRUE)/10000000, digits = 0),
        Total_Harvested_Acres = round(sum(`AREA HARVESTED_ACRES`, na.rm = TRUE)/100000)
      ) %>% 
      arrange(desc(YEAR))
    
    df[] <- lapply(df, function(x) format(x, nsmall = 0, scientific = FALSE))
    names(df) <- c("Year", paste0("Average \n YIELD \n (BU/ACRE)"),
                   paste0("Total\n Production\n (10 Million)"),
                   paste0("Total\n Harvested\n Acres\n (100 Thousand)"))
    df
  ...
  output$soybeans_intro <- renderTable({
    df <- soybeans_survey_final %>% 
      ...
      summarise(
        Average_YIELD = round(sum(`PRODUCTION_BU`, na.rm = TRUE)/sum(`AREA HARVESTED_ACRES`, na.rm = TRUE), digits = 0),
        Total_Production = round(sum(`PRODUCTION_BU`, na.rm = TRUE)/1000000, digits = 0),
        Total_Harvested_Acres = round(sum(`AREA HARVESTED_ACRES`, na.rm = TRUE)/100000)
      ) %>% 
      arrange(desc(YEAR))
    df[] <- lapply(df, function(x) format(x, nsmall = 0, scientific = FALSE))
  ...
  output$potatoes_intro <- renderTable({
    df <- potatoes_survey_final %>% 
      ...
      group_by(YEAR) %>% 
      summarise(
        Average_YIELD = round(sum(`PRODUCTION_CWT`, na.rm = TRUE)*1.667/sum(`AREA HARVESTED_ACRES`, na.rm = TRUE), digits = 0),
        Total_Production = round(sum(`PRODUCTION_CWT`, na.rm = TRUE)*1.667/100000, digits = 0),
        Total_Harvested_Acres = round(sum(`AREA HARVESTED_ACRES`, na.rm = TRUE)/1000)
      ) %>% 
      arrange(desc(YEAR))
    df[] <- lapply(df, function(x) format(x, nsmall = 0, scientific = FALSE))
    names(df) <- c("Year", paste0("Average \n YIELD \n (BU/ACRE)"),
  ...
  output$potatoes_plot <- renderPlot({
    df <- potatoes_survey_final %>% 
      ...
      summarise(
        Average_YIELD = round(sum(`PRODUCTION_CWT`, na.rm = TRUE)*1.667/sum(`AREA HARVESTED_ACRES`, na.rm = TRUE), digits = 0),
        Total_Production = round(sum(`PRODUCTION_CWT`, na.rm = TRUE)*1.667, digits = 0)/100000,
        Total_Harvested_Acres = round(sum(`AREA HARVESTED_ACRES`, na.rm = TRUE))/1000
      ) %>% 
      arrange(desc(YEAR))
    ...
    ggplot(data_long, aes(x = YEAR, y = Value, color = Parameter)) +
      ...
      labs(
        title = "Total Production (Scaled to 100 Thousand),\n Harvested Area (Scaled to 1 Thousand),\n and Average Yield Over Years",
      ...
      guides(        color = guide_legend(nrow = 3)  )   # Set the number of rows in the legend
  ...
  output$corn_plot <- renderPlot({
    df <- corn_survey_final %>% 
      ...
      summarise(
        Average_YIELD = round(sum(`PRODUCTION_BU`, na.rm = TRUE)/sum(`AREA HARVESTED_ACRES`, na.rm = TRUE), digits = 0),
        Total_Production = round(sum(`PRODUCTION_BU`, na.rm = TRUE), digits = 0)/10000000,
        Total_Harvested_Acres = round(sum(`AREA HARVESTED_ACRES`, na.rm = TRUE))/100000
      ) %>% 
      arrange(desc(YEAR))
    ...
    ggplot(data_long, aes(x = YEAR, y = Value, color = Parameter)) +
      ...
      geom_point(size = 2) +          # Add points for both metrics
      labs(
        title = "Total Production (Scaled to 10 Million),\n Harvested Area (Scaled to 100 Thousand),\n and Average Yield Over Years",
        x = "Year",
        y = "Value",
        color = "Parameters:"
      ) +
  ...
  output$soybeans_plot <- renderPlot({
    df <- soybeans_survey_final %>% 
      ...
      summarise(
        Average_YIELD = round(sum(`PRODUCTION_BU`, na.rm = TRUE)/sum(`AREA HARVESTED_ACRES`, na.rm = TRUE), digits = 0),
        Total_Production = round(sum(`PRODUCTION_BU`, na.rm = TRUE), digits = 0)/1000000,
        Total_Harvested_Acres = round(sum(`AREA HARVESTED_ACRES`, na.rm = TRUE))/100000
      ) %>% 
      arrange(desc(YEAR))
    ...
    ggplot(data_long, aes(x = YEAR, y = Value, color = Parameter)) +
      ...
      geom_point(size = 2) +          # Add points for both metrics
      labs(
        title = "Total Production (Scaled to 1 Million),\n Harvested Area (Scaled to 100 Thousand),\n and Average Yield Over Years",
        x = "Year",
        y = "Value",
        color = "Parameters:"
      ) +
